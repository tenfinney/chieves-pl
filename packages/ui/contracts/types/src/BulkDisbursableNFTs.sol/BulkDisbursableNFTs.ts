...
export interface BulkDisbursableNFTsInterface extends utils.Interface {
  functions: {
    ...
    "maxes(uint256)": FunctionFragment;
    ...
    "setMax(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setMax(uint256,int64)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setMax(uint256,uint256)",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "maxes", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "mint(address[],uint256,bytes)",
    data: BytesLike
  ): Result;
