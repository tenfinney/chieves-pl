import { f as forwardRef, u as useMultiStyleConfig, o as omitThemingProps, ar as split, as as layoutPropNames, ac as mergeWith, r as react, c as chakra, b as jsx, ae as dataAttr, a as cx, i as useWeb3, h as useNavigate, j as jsxs, F as Fragment, at as nftBase, R as React, a1 as Spinner } from "./index.1ecc66bf.js";
import { r as regexify, e as extractMessage, S as Stack, B as Box, q as isSet, l as lib, s as ipfsify, u as isEmpty, v as createIcon, U as UnorderedList, w as ListItem, F as Flex, x as SimpleGrid, d as Tooltip, h as httpURL, g as Center, L as Link, R as ReactMarkdown, T as Text, i as Table, j as Thead, k as Tr, n as Th, o as Tbody, p as Td } from "./index.8708a840.js";
import { a as useForm, I as Input, b as Image$1 } from "./index.esm.de70aaee.js";
import { u as useFormControl, F as FormControl, a as FormLabel } from "./chakra-ui-form-control.esm.6c89a3e4.js";
import { T as Tabs, a as TabList, b as Tab, c as TabPanels, d as TabPanel, R as RadioGroup, e as Radio, f as Textarea } from "./chakra-ui-textarea.esm.1c303b19.js";
import { B as Button } from "./chakra-ui-button.esm.0b033da9.js";
import { S as SubmitButton } from "./SubmitButton.570afe2d.js";
import { u as useToast } from "./chakra-ui-toast.esm.f1afa774.js";
function _extends() {
...
const OptionsForm = ({
  ...
  const submit = async (data) => {
    try {
      ...
      let metadata2 = await (async () => {
        switch (tab) {
          case FIELD_FORM: {
            return {
              name,
              content: JSON.stringify(await buildMeta(data), null, 2)
            };
          }
          case URI_FORM: {
            return data.uri;
          ...
          case JSON5_FORM: {
            ...
            return {
              name,
              content: JSON.stringify(lib.parse(data.json5), null, 2)
            };
          }
          default: {
      ...
      [metadata2] = await ipfsify(metadata2);
      await configure({
        metadata: metadata2
      });
    } catch (error) {
...
//# sourceMappingURL=MaxForm.d8924f19.js.map
