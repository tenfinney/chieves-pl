import { t as forwardRef, _ as __DEV__, v as useMultiStyleConfig, w as omitThemingProps, r as react, x as StylesProvider, g as chakra, y as cx, z as useStyles, A as mergeRefs, D as motion, E as useStyleConfig, u as useTheme, G as getCSSVar, J as isString, K as omit, L as pick, j as jsx, M as Fragment$1, d as jsxs, N as AnimatePresence, P as Portal$1, V as VisuallyHidden, O as useDisclosure, Q as useId, U as useEventListener, W as callAllHandlers, X as px, Y as CID, Z as ipfsLinkPattern, $ as NETWORKS, a0 as getAugmentedNamespace, a1 as getDefaultExportFromCjs, R as React$1, a2 as propTypes, a3 as Link$3, S as Stack, T as Text, F as Flex, a4 as Spinner, k as Box, a5 as Link$4, a6 as commonjsGlobal, a7 as propTypes$1, a8 as require$$1$2, a9 as require$$2$2, aa as jsxRuntime } from "./index.eb582024.js";
...
var TableCaption = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ react.exports.createElement(chakra.caption, _extends$8({}, rest, {
    ref,
    __css: _extends$8({}, styles2.caption, {
...
var Tooltip = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  if (userDefinedBg) {
    ...
    styles2[cssVars.arrowBg["var"]] = getCSSVar(theme, "colors", userDefinedBg);
  }
...
const ipfsify = async ({
  ...
  if (typeof value === "string") {
    if (value.startsWith("https://freeweb3.infura-ipfs.io/ipfs/")) {
      return value;
    }
  ...
  return `https://freeweb3.infura-ipfs.io/ipfs/${root2.toString()}/${list2[0].name}`;
};
const regexify = (str) => {
  if (!str)
    return str;
...
//# sourceMappingURL=styles.66348739.js.map
