import { a4 as getDefaultExportFromCjs, a8 as commonjsGlobal } from "./index.5f145343.js";
            ...
            return [2, new Promise(function(n3, r) {
              return i.__awaiter(void 0, void 0, void 0, function() {
                ...
                return i.__generator(this, function(s) {
                  switch (s.label) {
                    case 0:
                      return s.trys.push([0, 3, , 4]), M = { host: "mainnet" }, u = void 0, M = t2.networkParams || t2.network ? i.__assign({ host: t2.network }, t2.networkParams) : M, [4, (o = new e2({ buttonPosition: (null === (l = t2.config) || void 0 === l ? void 0 : l.buttonPosition) || "bottom-left", apiKey: (null === (I = t2.config) || void 0 === I ? void 0 : I.apiKey) || "torus-default", modalZIndex: (null === (N = t2.config) || void 0 === N ? void 0 : N.modalZIndex) || 99999 })).init(i.__assign(i.__assign({ showTorusButton: false }, t2.config), { network: M }))];
                    case 1:
...
//# sourceMappingURL=index.6b8a1c92.js.map
