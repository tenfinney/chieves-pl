import { f as forwardRef, I as omit, r as react, c as chakra, af as useSafeLayoutEffect, b as jsx, s as __DEV__, u as useMultiStyleConfig, o as omitThemingProps, a as cx, d as useStyles, x as getValidChildren, y as filterUndefined, S as StylesProvider, R as React } from "./index.2ada5cbf.js";
import { u as useFormControl } from "./chakra-ui-form-control.esm.30a9f0b8.js";
function _extends$1() {
...
var _excluded$4 = ["htmlWidth", "htmlHeight", "alt"], _excluded2$1 = ["fallbackSrc", "fallback", "src", "srcSet", "align", "fit", "loading", "ignoreFallback", "crossOrigin"];
var NativeImage = /* @__PURE__ */ react.exports.forwardRef(function(props, ref) {
  var htmlWidth = props.htmlWidth, htmlHeight = props.htmlHeight, alt = props.alt, rest = _objectWithoutPropertiesLoose$1(props, _excluded$4);
...
var Image$1 = /* @__PURE__ */ forwardRef(function(props, ref) {
  var fallbackSrc = props.fallbackSrc, fallback = props.fallback, src = props.src, srcSet = props.srcSet, align = props.align, fit = props.fit, loading = props.loading, ignoreFallback = props.ignoreFallback, crossOrigin = props.crossOrigin, rest = _objectWithoutPropertiesLoose$1(props, _excluded2$1);
  var shouldIgnore = loading != null || ignoreFallback || fallbackSrc === void 0 && fallback === void 0;
  var status = useImage(_extends$1({}, props, {
    ignoreFallback: shouldIgnore
  }));
  var shared = _extends$1({
    ref,
    objectFit: fit,
  ...
  if (status !== "loaded") {
    if (fallback)
      return fallback;
    return /* @__PURE__ */ react.exports.createElement(chakra.img, _extends$1({
      as: NativeImage,
...
var Input = /* @__PURE__ */ forwardRef(function(props, ref) {
  var htmlSize = props.htmlSize, rest = _objectWithoutPropertiesLoose(props, _excluded$3);
  ...
  return /* @__PURE__ */ react.exports.createElement(chakra.input, _extends({
    size: htmlSize
  }, input, {
    __css: styles.field,
    ref,
...
var InputAddon = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  var _props$placement = props.placement, placement = _props$placement === void 0 ? "left" : _props$placement, rest = _objectWithoutPropertiesLoose(props, _excluded$2);
...
var InputGroup = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  var _omitThemingProps = omitThemingProps(props), children = _omitThemingProps.children, className = _omitThemingProps.className, rest = _objectWithoutPropertiesLoose(_omitThemingProps, _excluded$1);
...
var _excluded = ["placement"], _excluded2 = ["className"], _excluded3 = ["className"];
...
var InputElement = /* @__PURE__ */ forwardRef(function(props, ref) {
  ...
  var _props$placement = props.placement, placement = _props$placement === void 0 ? "left" : _props$placement, rest = _objectWithoutPropertiesLoose(props, _excluded);
  var styles = useStyles();
  var input = styles.field;
...
var InputLeftElement = /* @__PURE__ */ forwardRef(function(props, ref) {
  var className = props.className, rest = _objectWithoutPropertiesLoose(props, _excluded2);
...
var InputRightElement = /* @__PURE__ */ forwardRef(function(props, ref) {
  var className = props.className, rest = _objectWithoutPropertiesLoose(props, _excluded3);
...
var getFieldValueAs = (value, {
  ...
  valueAsDate,
  setValueAs
}) => isUndefined(value) ? value : valueAsNumber ? value === "" || isNullOrUndefined(value) ? NaN : +value : valueAsDate && isString(value) ? new Date(value) : setValueAs ? setValueAs(value) : value;
...
//# sourceMappingURL=index.esm.64efabe1.js.map
