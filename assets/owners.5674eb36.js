import { aO as Token, aP as isDigit, aQ as isNameStart, aR as dedentBlockStringLines, aS as isNameContinue, aT as isSource, aU as Source, aV as Kind, aW as OperationTypeNode, aX as Location, aY as __assign, r as react, aZ as getApolloContext, a_ as invariant$1, a$ as React, b0 as canUseLayoutEffect, b1 as canUseWeakSet, b2 as maybeDeepFreeze, b3 as NetworkStatus, b4 as canUseWeakMap, b5 as equal, b6 as compact, b7 as mergeOptions, b8 as __rest, b9 as isNonEmptyArray, ba as ApolloError, d as chakra, W as Link, aM as useParams, u as useSearchParams, bb as contractNetwork, g as useWeb3, a as jsx, z as Fragment, j as jsxs, Y as Box, ad as Heading, aN as OrderedList, an as ListItem } from "./index.8c16fa1d.js";
import contractAddress from "./BulkDisbursableNFTs.address.1bbaa9f9.js";
import { o as deregexify, n as capitalize, h as httpURL } from "./LinkedSVG.e13e285a.js";
...
const Owners = () => {
  ...
  const [title, setTitle] = react.exports.useState("\u{1D61C}\u{1D62F}\u{1D62C}\u{1D62F}\u{1D630}\u{1D638}\u{1D62F}");
  const {
    ensProvider,
    roContract
  } = useWeb3();
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ml: 8,
    children: [/* @__PURE__ */ jsx(HomeLink, {}), /* @__PURE__ */ jsx(Heading, {
      mt: 10,
      fontSize: 20,
      children: title
      ...
      children: [/* @__PURE__ */ jsx(AlertIcon, {}), /* @__PURE__ */ jsx(AlertTitle, {
        ...
        children: ["No owners found for token #", nftId, "."]
      })]
...
//# sourceMappingURL=owners.5674eb36.js.map
