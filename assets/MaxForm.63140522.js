import { t as forwardRef, K as omit, r as react, g as chakra, ah as useSafeLayoutEffect, j as jsx, v as useMultiStyleConfig, w as omitThemingProps, aq as split, ar as layoutPropNames, as as useFormControl, at as mergeWith, aj as dataAttr, y as cx, p as useWeb3, o as useNavigate, au as useConfig, d as jsxs, S as Stack, k as Box, I as Input, av as createIcon, M as Fragment, aw as nftBase, ax as UnorderedList, ay as ListItem, e as FormControl, F as Flex, h as FormLabel, az as SimpleGrid, R as React, ao as Center, B as Button, a5 as Link, T as Text, a4 as Spinner } from "./index.eb34fb48.js";
import { k as isSet, m as ipfsify, n as isEmpty, r as regexify, e as extractMessage, l as lib, a as Tooltip, h as httpURL, R as ReactMarkdown, c as Table, d as Thead, f as Tr, g as Th, i as Tbody, j as Td } from "./styles.b911a161.js";
import { u as useForm } from "./index.esm.dd0191a2.js";
import { T as Tabs, a as TabList, b as Tab, c as TabPanels, d as TabPanel, R as RadioGroup, e as Radio, f as Textarea } from "./chakra-ui-textarea.esm.2044d0d9.js";
import { S as SubmitButton } from "./SubmitButton.dbc67cba.js";
import { u as useToast } from "./chakra-ui-toast.esm.8fc22ea0.js";
function _extends$1() {
...
var _excluded$1 = ["htmlWidth", "htmlHeight", "alt"], _excluded2$1 = ["fallbackSrc", "fallback", "src", "srcSet", "align", "fit", "loading", "ignoreFallback", "crossOrigin"];
var NativeImage = /* @__PURE__ */ react.exports.forwardRef(function(props, ref) {
  var htmlWidth = props.htmlWidth, htmlHeight = props.htmlHeight, alt = props.alt, rest = _objectWithoutPropertiesLoose$1(props, _excluded$1);
...
const OptionsForm = ({
  ...
  const buildMeta = react.exports.useCallback(async (data) => {
    const {
      name,
      description,
      homepage,
  ...
  const submit = react.exports.useCallback(async (data) => {
    try {
              ...
              switch (tab) {
                case URI_FORM: {
                  if (uri && uri !== "") {
                    ...
                    metadata2 = lib.parse(await res.text());
                  }
                  break;
                }
                case JSON5_FORM: {
                  if (json5 && json5 !== "") {
                    metadata2 = lib.parse(json5);
                  }
                  break;
                }
              }
...
const JSONForm = ({
  ...
  h: "75vh",
  ...register("json5"),
  children: lib.stringify(metadata)
});
const MaxForm = ({
  tokenId,
  purpose = "create",
...
//# sourceMappingURL=MaxForm.63140522.js.map
